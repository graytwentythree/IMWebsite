...
try {
	...
	$sql = "CREATE TABLE IF NOT EXISTS users(Username TEXT, Password TEXT, Color TEXT, LD TEXT, DisplayName TEXT, CurrentPage TEXT, CurrentTime BIGINT, UserID INTEGER AUTO_INCREMENT UNIQUE NOT NULL)";
	$connection->exec($sql);
	$sql = "CREATE TABLE IF NOT EXISTS postingBoards(Creator INTEGER, Title TEXT, Description TEXT, Private BOOLEAN, BoardID INTEGER AUTO_INCREMENT UNIQUE NOT NULL)";
	$connection->exec($sql);
